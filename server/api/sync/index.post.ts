...
interface ApiModel {
    ...
    cost: { input: number; output: number; cache_read?: number; cache_write?: number; reasoning?: number; input_audio?: number; output_audio?: number };
...
export default defineEventHandler(async (event) => {
    ...
    const response = await $fetch<Record<string, ApiProvider>>(
